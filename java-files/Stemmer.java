...
public class Stemmer {  
   ...
   */
   ...
   public String performStem (String text) {
	   
	   char[] w = new char[501];
	   Stemmer s = new Stemmer();
	   StringBuffer stemmedOutput = new StringBuffer();
//	   System.out.println("************** Stemmer Started ****************");
...
//        		 System.out.print((char)ch);
         ...
         return stemmedOutput.toString();
   }
   	public static void main(String[] args) {
   		Stemmer s = new Stemmer();
   		String testString = "can't The core issue here is that stemming algorithms operate on a phonetic " +
...
//   				"File1	An extraneous element cling ";
   		System.out.println(s.performStem(testString));
   	}
}